...
**Returns**: `{ success, timedOut, durationMs, testSummary: {total, passed, failed, ignored, durationMs}, testResults: [{name, status, durationMs, className, locationUrl, errorMessage, errorStackTrace}], truncated, rawOutput? }`
